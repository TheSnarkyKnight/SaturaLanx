...
import com.snark.saturalanx.entities.EntitySmokeBomb;
...
public class RenderSmokeBomb extends Render {
    public RenderSmokeBomb(){
    ...
    public void render(Entity entity, double x, double y, double z, float entityYaw, float partialTicks) {
        ...
        this.renderItem(Tessellator.instance, ItemSetup.smokeBomb.getIcon(new ItemStack(ItemSetup.smokeBomb,1,((EntitySmokeBomb)entity).getColour()), 0));
    ...
    public void doRender(Entity entity, double v, double v1, double v2, float v3, float v4) {
        this.render(entity,v,v1,v2,v3,v4);
    }
