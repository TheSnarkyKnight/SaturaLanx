...
public class RenderBullet extends Render {
    ...
    public void render(EntityBullet entity, double x, double y, double z, float entityYaw, float partialTicks) {
        GL11.glPushMatrix();
        GL11.glTranslatef((float) x, (float) y, (float) z);
        GL11.glEnable(GL12.GL_RESCALE_NORMAL);
        GL11.glScalef(1.0F, 1.0F, 1.0F);
        this.bindEntityTexture(entity);
        this.renderItem(Tessellator.instance, ItemSetup.dummyBullet.getIconFromDamage(entity.getType()));
    ...
    public void doRender(Entity entity, double x, double y, double z, float entityYaw, float partialTicks) {
        this.render((EntityBullet) entity, x, y, z, entityYaw, partialTicks);
    }
